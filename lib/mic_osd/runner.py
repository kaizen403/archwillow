...
"""
        ...
        log_file = Path('/tmp/mic-osd.log')
        # Use the hyprwhspr venv Python so sounddevice and other deps are available
        venv_python = Path.home() / '.local' / 'share' / 'hyprwhspr' / 'venv' / 'bin' / 'python'
        try:
